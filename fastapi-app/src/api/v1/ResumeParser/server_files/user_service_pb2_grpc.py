...
from src.api.v1.ResumeParser.server_files.user_service_pb2 import CreateUserRequest, CreateUserResponse, LoginUserRequest, LoginUserResponse, TokenRequest, TokenValidationResponse
