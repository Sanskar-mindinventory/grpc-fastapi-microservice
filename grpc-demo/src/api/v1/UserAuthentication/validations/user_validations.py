from src.api.v1.UserAuthentication.utils.constants import username_REGEX, ERR_INVALID_USERNAME, PASSWORD_REGEX, \
...
def username_validation(username=None):
    ...
    """
    return RegexValidation(username, username_REGEX, ERR_INVALID_USERNAME).regex_validator()
